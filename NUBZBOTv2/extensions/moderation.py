...
async def ban(ctx: lightbulb.Context) -> None:
    ...
    logger.info(f"{ctx.author} banned {user} from guild {ctx.guild_id} for: {reason}, in guild {ctx.guild_id}")
...
async def unban(ctx: lightbulb.Context) -> None:
    ...
    for x in ban_list:
        ...
        if (bannedGuy_name, bannedGuy_disc) == (username, user_disc):
            ...
            logger.info(f"{ctx.author} unbanned {user} from {ctx.guild_id}")
...
async def kick(ctx: lightbulb.Context) -> None:
    ...
    logger.info(f"{ctx.author} kicked {user} for: {reason} in guild {ctx.guild_id}")
...
async def tempban(ctx: lightbulb.Context) -> None:
    ...
    logger.info(f"{ctx.author} temp banned {user} for {interval}{smhd} for: {reason}, in guild {ctx.guild_id}")
    ...
    logger.info(f"{user} got unbanned from guild {ctx.guild_id} after {interval}{smhd} for: {reason}. Banner {ctx.author}")
...
async def clear(ctx: lightbulb.Context) -> None:
    ...
    if is_muted_role:
        ...
        logger.info(f"{ctx.author} muted {user} for: {reason}, in guild {ctx.guild_id}")
...
async def unmute(ctx: lightbulb.Context):
    ...
    logger.info(f"{ctx.author} unmuted {user} in guild {ctx.guild_id}")
...
async def tempmute(ctx: lightbulb.Context) -> None:
    ...
    if is_muted_role:
        ...
        logger.info(f"{ctx.author} tempmuted {user} for: {reason}, time: {interval}{smhd}. In guild {ctx.guild_id}")
    ...
    logger.info(f"{user} was unmuted from {ctx.guild_id} after {interval}{smhd} for: {reason}. Muter: {ctx.author}")
...
async def purge(ctx: lightbulb.Context) -> None:
    ...
    logger.info(f"{ctx.author} purged {amount} messages in {ctx.guild_id}")
